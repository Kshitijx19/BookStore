...
const Sidebar = ({ data }) => {
  ...
  return (
    ...
    {role==="admin" && (
      ...
      {/* Logout Button */}
      <button className="bg-zinc-900 w-3/6 lg:w-full mt-4 text-white font-semibold flex items-center justify-center py-2 rounded hover:bg-zinc-700 transition-all duration-300"
    onClick={() => {
